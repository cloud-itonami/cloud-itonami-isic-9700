...
```bash
kbb -M:dev:run     # walk two clean dispatch+pay lifecycles (no vulnerable person, vulnerable person with safeguarding verified), plus four HARD-hold cases, through the actor
