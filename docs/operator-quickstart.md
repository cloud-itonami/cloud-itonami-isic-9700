# Operator Quickstart — Community Domestic Employment

Shortest path from clone to a verified local dry-run for **ISIC 9700** (`cloud-itonami-isic-9700`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9700.git
cd cloud-itonami-isic-9700
```
...
- Blueprint governor key: `domestic-employment-governor`
- Likely source path: `domesticops.governor.cljc`
